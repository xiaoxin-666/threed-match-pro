package com.caluad.match3d.ui.navigation
...
import com.caluad.match3d.service.TaskForegroundService
import com.caluad.match3d.ui.console.ConsoleScreen
import com.caluad.match3d.ui.console.ConsoleViewModel
import com.caluad.match3d.ui.dashboard.DashboardScreen
import com.caluad.match3d.ui.dashboard.DashboardViewModel
import com.caluad.match3d.ui.probe.ProbeScreen
import com.caluad.match3d.ui.proxy.ProxyScreen
import com.caluad.match3d.ui.proxy.ProxyViewModel
import com.caluad.match3d.ui.task.TaskEditDialog
import com.caluad.match3d.ui.task.TaskListScreen
import com.caluad.match3d.ui.task.TaskViewModel
...
fun AppNavigation() {
    ...
    val engineState = engine.engineState.collectAsStateWithLifecycle(initialValue = com.caluad.match3d.engine.EngineState()).value
